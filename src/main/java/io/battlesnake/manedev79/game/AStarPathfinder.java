...
public class AStarPathfinder implements Pathfinder {
    ...
    public AStarPathfinder(ExecutorService executorService) {
        this.executorService = executorService;
    }

    @Override
    public Path findPath(Board board, Field start, Field destination) {
        return new AStarInternal().findPath(board, start, destination);
    }

    private class AStarInternal implements Pathfinder {
